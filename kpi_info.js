...
$(document).ready(function () {
    ...
    $('#filter_department_id').on('change', function () {
        ...
        $('#filter_department_id').parent().removeClass('error');
    ...
    $('#filter_position_id').on('change', function () {
        ...
        // Reset_KRA_Fields();
        $('#filter_position_id').parent().removeClass('error');
    })
    /*
...
function ReadKRAListItem(position_id) {
    ...
    $('#loader').fadeIn(500);
    $.ajax({
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('Key Result Area')/items?$select=Title, ID, AttachmentFiles, Position_x0020_Title/Title, Position_x0020_Title/ID&$expand=Position_x0020_Title&$$expand=AttachmentFiles&$OrderBy=Title&$filter=(Position_x0020_Title/ID eq '" + position_id + "') and (Archived eq '0') ",
    ...
    if ((myID.length < 1) || isNaN(myID)) {
        ...
        $.ajax({
            ...
            success: function (data) {
                DisplayMetricsInfo();
                //alert("success");  
                document.getElementById("message_success_id").innerHTML = "<div class='ui positive compact message'><p><i class='check circle icon'></i>Metrics Successfully Archived! </p></div>"
                setTimeout(function () {
                    $('.message')
                        .closest('.message')
                        .transition('fade');
        ...
        if (rowCount == 0) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    ReadKPIListItem(kpi_select_pos_val);
                    document.getElementById("message_success_id").innerHTML = "<div class='ui positive compact message'><p><i class='check circle icon'></i>KPI Successfully Archived! </p></div>"
                    setTimeout(function () {
                        $('.message')
                            .closest('.message')
                            .transition('fade');
        ...
        if (rowCount == 0) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("message_success_id").innerHTML = "<div class='ui positive compact message'><p><i class='check circle icon'></i>KRA Successfully Archived! </p></div>"
                    setTimeout(function () {
                        $('.message')
                            .closest('.message')
                            .transition('fade');
...
function edit_metric_onClick(set_metric_edit_id) {
    ...
    $.ajax({
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('Metrics')/items?$select=Title, ID, Key_x0020_Performance_x0020_Indi/Title,Key_x0020_Performance_x0020_Indi/ID, Score, Remarks&$expand=Key_x0020_Performance_x0020_Indi&$OrderBy=Score&$filter= (ID eq '" + set_metric_edit_id + "') and (Archived eq '0') ",
        method: "GET",
        headers: { "Accept": "application/json; odata=verbose" },
        success: function (data) {
...
function edit_kra_item_onClick(set_kra_id) {
    ...
    $.ajax({
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('Key Result Area')/items?$select=Title, ID,  Position_x0020_Title/Title, Position_x0020_Title/ID&$expand=Position_x0020_Title&$OrderBy=Title&$filter= (ID eq '" + set_kra_id + "') and (Archived eq '0')  ",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                ...
                url: _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('Key Result Area')/items?$select=Title, ID,  Position_x0020_Title/Title, Position_x0020_Title/ID&$expand=Position_x0020_Title&$OrderBy=Title&$filter= (Position_x0020_Title/ID eq '" + kpi_select_pos_val + "') and (Archived eq '0')  ",
