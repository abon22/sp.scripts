...
$(document).ready(function() {
    ...
    $('#filter_department_id').on('change', function() {
        console.log('filter_department_id changed')
    ...
    ReadDepartmentListItem('IT');//Change Department Title Here
...
function ReadDepartmentListItem(department_title) {
    var department_title = department_title ;
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var a = 0; a < datares_departments.length; a++) {
                ...
                departmen_list += "<div class='item' data-value='" + datares_departments[a].ID + "' data-title='"+datares_departments[a].Title+"' >" + datares_departments[a].Title + "</div>";
        ...
        var data_value = $("#append_dept_id").find("[data-title='"+department_title+"']").attr('data-value');
        // console.log(data_value);
         $('#text_department_id').html(department_title);
         $('#filter_department_id').val(data_value).change();
