...
function GetPORListItem(selected_year, selected_month)  
{
  ...
  z=1;
	...
	$.ajax({
		url:  _spPageContextInfo.webAbsoluteUrl  + "/_api/web/lists/getbytitle('Payments/CA Request')/items?$select=Title, Created, ID &$OrderBy=Title desc&$top=9999",
		method: "GET",
...
var b=0;
    ...
    // for (var b = 0; b < arr_findThis.length; b++) {
      ...
      if(global_versionEntries[item][item2]){
         ...
         // val_temp = ((global_versionEntries[item][item2]=== "undefined")?"a":"b");;
...
//console.log(val_temp);
           ...
           // console.log("=================start=========================");
            ...
            //console.log(val_temp);
           // console.log(ref_no_temp);
           // console.log({[arr_keyToFind[b]]: val_temp, "Modified": val_modified_date});
           // console.log("====================end======================");
              ...
              //por_object[ref_no_temp]['01_Immediate_Head'] ="error";
